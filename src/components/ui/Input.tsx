...
const UNDERLINED_BASE =
    'w-full border-0 border-b border-white/20 bg-transparent py-2 text-white placeholder-white/35 transition-colors focus:border-b-2 focus:border-info focus:shadow-[0_4px_8px_-4px_rgba(0,240,255,0.4)] focus:outline-none';

const BOXED_BASE =
    'w-full rounded border border-outline bg-white/5 text-white placeholder-white/35 transition-colors focus:border-info focus:outline-none';
