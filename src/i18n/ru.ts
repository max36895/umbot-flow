export default {
    ...
    'export.unconnected':
        'Не подключено к флоу: {blocks}. В сгенерированном проекте эти блоки не создадутся — CLI собирает обработчики только для блоков, связанных рёбрами или кнопками. Подключите их рёбрами к команде/шагу, если они нужны боту.',
